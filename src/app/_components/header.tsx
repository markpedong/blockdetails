...
import { getGlobalCrypto } from '@/_api'
import { MODAL_FORM_PROPS, PAP_FIAT } from '@/_constants'
import { setCurrency, setGlobalData, toggleDarkMode } from '@/_redux/features/globalSlice'
import { AppDispatch, useAppSelector } from '@/_redux/store'
import { numberWithSuffix } from '@/_utils'
