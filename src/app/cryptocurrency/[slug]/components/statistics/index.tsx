		...
		<Col span={9}>
			<Card title={`${coin.symbol} Price Statistics`} bordered>
				...
				<StatsPer
					...
					data={coinCG.market_data?.price_change_percentage_30d_in_currency[symbol?.toLowerCase()]?.toFixed(
						2
					)}
				...
				<StatsPer
					...
					data={coinCG.market_data?.price_change_percentage_60d_in_currency[symbol?.toLowerCase()]?.toFixed(
						2
					)}
